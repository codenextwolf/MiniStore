package com.wolf.android.ministore;

//Add this code BELOW your package name in MainActivity
...
public class MainActivity extends Activity {
    ...
    CheckBox nameEmbroideryCheckBox;
    boolean addCleaningKit;
    boolean addShoeStrings;
    boolean addNameEmbroidery;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameEmbroideryCheckBox = (CheckBox) findViewById(R.id.name_embroidery_checkbox);
    }
    ...
    public void submitOrder(View view) {
        ...
        if(addNameEmbroidery) {
            orderMessage += "Added Name Embroidery ($50): Please reply to this email with the name you would like embroidered\n" ;
        }
    ...
    private int calculatePrice() {
        ...
        addNameEmbroidery = nameEmbroideryCheckBox.isChecked();
